...
```{r}
#| panel: fill
plotlyOutput('plot_flux', height = 500)
```
...
```{r}
#| panel: fill
plotlyOutput('plot_part', height = 500)
```
...
```{r}
#| panel: fill
plotlyOutput('plot_met', height = 500)
```
...
```{r}
#| panel: fill
plotlyOutput('plot_redox', height = 500)
```
...
```{r}
#| panel: fill
plotlyOutput('plot_teros', height = 500)
```
...
```{r}
#| panel: fill
plotlyOutput('plot_bme', height = 500)
```
